...
solve the problem. The function perform a binary search for the most significant active bit.
...
The minimum number in a two's complement system is represented by having the most significant bit set to 1 and then rest of the bits set to 0.
